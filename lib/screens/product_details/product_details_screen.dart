...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
                  ...
                  child: Column(
                      ...
                      Row(
                        children: [
                         Text(
                          ...
                          Text(
                            widget.groceryItem.productPrice,
                            style: TextStyle(
                              fontSize: 20,
                    ...
                    Align(
                      ...
                      child: RatingBarIndicator(
                        rating: 5,//double.parse(widget.groceryItem.rating),
                        itemCount: 5,
                        itemSize: 25,
  ...
  Widget getImageHeaderWidget() {
    return Container(
      ...
      child: Image.network(widget.groceryItem.image)
    );
  }
